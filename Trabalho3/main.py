...
def main():
	...
	problema = ia.ProblemaBuscaSimulatedAnnealing(teste, operadores,num_func,num_turnos,melhor_avaliado,avaliar_estado,metodo)	
	...
	if metodo==1:
		...
		fim = time.time()
		if(metodo==1):
			print ("Busca tempera simulada Finalizada")
			print ("Estado Inicial:")
			ia.imprime_estado(problema,teste)
			print ("\nSaida Busca Temper simulada: ")
